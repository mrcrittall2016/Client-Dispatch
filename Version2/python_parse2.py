...
if Day == 'Wednesday':
	...
	if not os.path.exists("/Users/matthewcrittall/Documents/Programming/Webdev/Python/Projects/Dispatch_Python/dispatch_client/Version2/%s/%s_%s" % (Year, Month, Year)):
		os.makedirs("/Users/matthewcrittall/Documents/Programming/Webdev/Python/Projects/Dispatch_Python/dispatch_client/Version2/%s/%s_%s" % (Year, Month, Year))	
	...
	save_location = "/Users/matthewcrittall/Documents/Programming/Webdev/Python/Projects/Dispatch_Python/dispatch_client/Version2/%s/%s_%s/%s_%s_%s.xlsm" % (Year, Month, Year, day_number, Month, Year)
